...
<h3><b>The objective to learn Linear Regression:</h3></b>
<ul>
  <li><h3>To explain the variation in one variable that is dependent variable based on one or more other variables which are independent variables</h3></li>
</ul>  
